...
<?php
\MissionNext\lib\core\Context::getInstance()->getResourceManager()->addJSResource('mn/common/agency_table', 'common/agency_table.js', array( 'jquery', 'jquery-ui-dialog' ), false, true);
?>