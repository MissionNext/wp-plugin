...
<div class="page-header">
    <h1><?php echo __("Inquire list", \MissionNext\lib\Constants::TEXT_DOMAIN) ?></h1>
</div>
<div class="page-content">
    ...
    <table class="table result">
        ...
        <tr data-id="<?php echo $inquire['id'] ?>">
            ...
            <td class="name"><a href="/job/<?php echo $inquire['id'] ?>"><?php echo $inquire['name'] ?></a></td>
            <td class="name"><a href="/organization/<?php echo $inquire['organization']['id'] ?>"><?php echo $inquire['organization']['profileData']['organization_name'] ?></a></td>
            <td class="favorite">
