...
function function_print() {
    window.open("https://info.missionfinder.net/print_profile.php?uid=<?php echo $pass_string ?>&site=<?php echo $site ?>");
}
</script>
              
                <div class="buttons"> 
            	<!--<a href="https://info.missionfinder.net/print_profile.php?uid=<?php echo $pass_string ?>&site=<?php echo $site ?>" title="Printer Friendly Display" target="_blank"><button class="btn btn-default">Your Profile</button></a>-->
