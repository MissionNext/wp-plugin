...
<div id="payment_total_cart">
    ...
    <p class="coupon"> <?php $Coupon_="Yes"; echo __("Coupon", \MissionNext\lib\Constants::TEXT_DOMAIN) ?>: $<span>0.00</span></p>
    <?php if($fee > 0): ?>
    ...
    <?php else: ?>
    <p class="subtotal"> <?php echo __("Total", \MissionNext\lib\Constants::TEXT_DOMAIN) ?>: $<span>0.00</span></p>
    <?php endif; ?>
    <div>
